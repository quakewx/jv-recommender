...
(function () {
  ...
  // 每项磁链字段：name / hash / size(字节) / cnsub(中字bool) / hd(bool) / files_count / created_at / pikpak_url
  ...
  function gradeMagnet(m) {
    ...
    const sz = m.size || 0;                                  // 体积越大质量通常越高
    if (sz > 1024 * 1024 * 1024) score += 30;
    else if (sz > 300 * 1024 * 1024) score += 12;
